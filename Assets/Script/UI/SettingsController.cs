...
public class SettingsController : MonoBehaviour
{
    ...
    private void InitializeSettings()
    {
        ...
        // Grafik ve ��z�n�rl�k dropdown'lar�n� haz�rla
        RefreshDropdowns();
    }
    ...
    {
        // Mevcut ses ayarlar�n� AudioManager'dan �ek
    ...
    {
        // Grafik kalitesi ayar�n� ve ��z�n�rl��� g�ncelle
    ...
    private int GetResolutionDropdownIndex(Resolution resolution)
    {
        ...
        return 0; // Varsay�lan olarak 720p
    }
