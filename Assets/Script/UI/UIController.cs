...
public class UIController : MonoBehaviour
{
    ...
    public void ShowTab(int tabIndex)
    {
        ...
        // Belirtilen sekme i�eri�ini etkinle�tir.
        Debug.Log(tabIndex);
        tabContents[tabIndex].SetActive(true);
        // Di�er sekmelerin i�eri�ini devre d��� b�rak.
        ...
        // Belirtilen sekme d��mesini vurgula, di�erlerini vurgulamay� kald�r.
        ...
        currentTab = tabIndex;  // �u anki sekme indeksi g�ncelle.
    }
    public void ShowSkillInfo(int _id) // Skill Buttons
    {
        ...
        if (SkillTreeManager.instance.SelectedSkillGameObject != null)
        {
            ...
            // Pozisyonu belirlemek i�in bir switch-case yap�s� kullan
            ...
            {
                case BaseSkillOptions.SkillPoint.Point1: // Sol �st k��e
                    panelRectTransform.pivot = new Vector2(1, 0);
                    pointerIndex = 3;
                    break;
                case BaseSkillOptions.SkillPoint.Point2: // Sa� �st k��e
                    panelRectTransform.pivot = new Vector2(0, 0);
                    pointerIndex = 2;
                    break;
                case BaseSkillOptions.SkillPoint.Point3: // Sol alt k��e
                    ...
                    break;
                case BaseSkillOptions.SkillPoint.Point4: // Sa� alt k��e
        ...
        // Kilidi a��labilir veya a��lamazsa d��meyi g�ncelle
    ...
    public void BuySkill() // SKILL SATIN ALMA BUTONU!
    {
        ...
        if (MuseumManager.instance.GetCurrentGold() >= currentSkill.SkillRequiredMoney && MuseumManager.instance.GetCurrentSkillPoint() >= currentSkill.SkillRequiredPoint)
        {
            if (currentSkill.SkillCurrentLevel < currentSkill.SkillMaxLevel)
            {
                ...
                Debug.Log($"Skill => {currentSkill.SkillName} Yetenek leveli => {currentSkill.SkillCurrentLevel} Yetenek Puan� => {currentSkill.SkillRequiredPoint}");
    ...
    public void InsufficientGoldEffect()
    {
        ...
        GoldText.transform.DOShakePosition(0.5f, new Vector3(10, 0, 0), 10, 90, false, true).OnComplete(() =>
        {
            ...
            {
                Debug.LogError("Ge�ersiz hexadecimal renk kodu: " + hexColor);
            }
    ...
    public void SpiderMove(GameObject _newSpider)
    {
        if (_newSpider != null)
        {
            ...
            .OnComplete(() =>
            {
                // �kinci sallama ve ba�lang�� konumuna d�nme
