...
public class LanguageDatabase : MonoBehaviour
{
    ...
    public async Task LoadLanguageData()
    {
        ...
        {
            // Dosya yoksa �eviri yap ve JSON dosyas�n� olu�tur.
    ...
    void LanguageFilling()
    {
        ...
        Language.customize_OnExitProcessStrings = new List<LanguageData> { new LanguageData(0, "Karakter �zelle�tirmesi"), new LanguageData(1, "De�i�iklikleri onayl�yor musunuz?") };
        //Customization
        //General
    }
    ...
    private async Task TranslateAndSaveLanguageData()
    {
        ...
        //Customization
        //GeneralAdding
        // JSON dosyas�n� kaydet
        string jsonString = JsonUtility.ToJson(Language);
        string directoryPath = "Assets/Resources/Languages"; // Resources klas�r� i�indeki Languages klas�r�
        ...
        // Dosya yolu var m� kontrol et, yoksa olu�tur
        if (!Directory.Exists(directoryPath))
        {
            Directory.CreateDirectory(directoryPath);
        }

        // Dosyay� olu�tur ve i�ine yaz
        File.WriteAllText(filePath, jsonString);

        Debug.Log("�eviri ve kay�t i�lemi tamamland�.");
