...
public class StatuesHandler
{
    ...
    public List<EditObjData> editObjs = new List<EditObjData>(); // Databaseden cekilmeli
    public List<EditObjData> currentEditObjs = new List<EditObjData>(); // Databaseden cekilmeli
    ...
    public void AddEditObjs()
    {
        ...
        EditObjData objData5 = new EditObjData(6, "Decoration1", 100, (Texture2D)decorationResults[0], EditObjType.Decoration, new List<(EditObjBonusType _bonusses, int _value)>(), 5);
        EditObjData objData6 = new EditObjData(7, "Decoration2", 200, (Texture2D)decorationResults[1], EditObjType.Decoration, new List<(EditObjBonusType _bonusses, int _value)>(), 5);
        EditObjData objData7 = new EditObjData(8, "Decoration3", 300, (Texture2D)decorationResults[2], EditObjType.Decoration, new List<(EditObjBonusType _bonusses, int _value)>(), 5);
        EditObjData objData8 = new EditObjData(9, "Decoration4", 400, (Texture2D)decorationResults[3], EditObjType.Decoration, new List<(EditObjBonusType _bonusses, int _value)>(), 5);
        EditObjData objData9 = new EditObjData(10, "Decoration5", 500, (Texture2D)decorationResults[4], EditObjType.Decoration, new List<(EditObjBonusType _bonusses, int _value)>(), 5);
        ...
        currentEditObjs = editObjs; // database islemleri olmali.
    }
