            ...
            query.GetSnapshotAsync().ContinueWithOnMainThread(task =>
            {
                if (task.IsCompleted)
                {
                    ...
                    else
                    {
                        ...
                        {
                            // Her bir rengi RGB de�erleriyle bir dictionary olarak kaydediyoruz
                    ...
                    for (int i = 0; i < 3; i++)
                    {
                        ...
                        foreach (DocumentSnapshot customDocumentSnapshot in customQuerySnapshot.Documents)
                        {
                            if (customDocumentSnapshot.Exists)
                            {
                                ...
                                {
                                    // Her bir renk dictionary'sini al�yoruz
                                    Dictionary<string, object> colorData = colorDataObj as Dictionary<string, object>;

                                    if (colorData != null)
                                    {
                                        // Dictionary i�inden RGB de�erlerini al�yoruz
                                        ...
                                        // Yeni Color objesi olu�turuyoruz
